...
export const useLoginForm = (options: UseLoginFormOptions = {}) => {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      // Previously had debugging code here to force show anti-sharing error dialog
      // This is now handled through our SessionExceptionHandler component
      // and useSessionAlert hook
