  ...
  return (
    <div className="flex justify-between items-center w-full mb-8 relative">
      ...
      {steps.map((step, index) => {
        ...
        const isCompleted = 
          (step.key === 'account' && ['personal', 'confirmation', 'success'].includes(currentStep)) ||
          (step.key === 'personal' && ['confirmation', 'success'].includes(currentStep)) ||
          (step.key === 'confirmation' && currentStep === 'success');
