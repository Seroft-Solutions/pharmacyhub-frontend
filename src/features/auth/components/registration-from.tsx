...
import PharmacistForm from "@/features/pharmacist/components/PharmacistForm";
import ProprietorForm from "@/features/proprietor/components/ProprietorForm";
import SalesmanForm from "@/features/salesman/components/SalesmanForm";
import PharmacyMangerForm from "@/features/pharmacy-manager/components/PharmacyManagerForm";
import {Card, CardContent, CardFooter, CardHeader, CardTitle} from "@/components/ui/card";
import {Dialog, DialogContent} from "@/components/ui/dialog";
import {Button} from "@/components/ui/button";
import serviceLocator from "@/lib/service-locator";
import { PharmacistData, PHUserDTO } from "@/services/pharmacist";
...
export default function RegistrationForm({open, onOpenChange}: RegistrationFormProps) {
  ...
  const renderForm = () => {
    ...
    switch (selectedUserType) {
      case "pharmacist":
        return <PharmacistForm createPharmacist={(data: PharmacistData): Promise<PHUserDTO> => serviceLocator.get('pharmacistService').createPharmacist(data)} />;
      case "proprietor":
        return <ProprietorForm />;
      case "pharmacy_manager":
        return <PharmacyMangerForm />;
      case "salesman":
        return <SalesmanForm />;
      default:
        return null;
