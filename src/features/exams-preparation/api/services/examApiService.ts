...
export const examApiService = createExtendedApiService<Exam, {
  ...
  EXAM_ENDPOINTS.all,
  {
    // Exam operations
    getAllExams: async () => {
      return await apiClient.get<Exam[]>(EXAM_ENDPOINTS.all);
    },
    ...
    getExamById: async (examId) => {
      return await apiClient.get<Exam>(EXAM_ENDPOINTS.byId.replace(':id', toLongId(examId)));
    },
    ...
    // Paper operations
    getAllPapers: async () => {
      return await apiClient.get<ExamPaper[]>(PAPER_ENDPOINTS.all);
    },
    
    getModelPapers: async () => {
      return await apiClient.get<ExamPaper[]>(PAPER_ENDPOINTS.model);
    },
    
    getPastPapers: async () => {
      return await apiClient.get<ExamPaper[]>(PAPER_ENDPOINTS.past);
    },
    
    getSubjectPapers: async () => {
      return await apiClient.get<ExamPaper[]>(PAPER_ENDPOINTS.subject);
    },
    
    getPracticePapers: async () => {
      return await apiClient.get<ExamPaper[]>(PAPER_ENDPOINTS.practice);
    },
    
    getPaperById: async (id) => {
      return await apiClient.get<ExamPaper>(PAPER_ENDPOINTS.byId.replace(':id', toLongId(id)));
    },
    ...
    getUserExamAttempts: async () => {
      return await apiClient.get<ExamAttempt[]>(ATTEMPT_ENDPOINTS.all);
    },
    
    getUserExamAttemptsForExam: async (examId) => {
      return await apiClient.get<ExamAttempt[]>(ATTEMPT_ENDPOINTS.byExam.replace(':id', toLongId(examId)));
    },
    
    getExamAttempt: async (attemptId) => {
      return await apiClient.get<ExamAttempt>(ATTEMPT_ENDPOINTS.byId.replace(':id', toLongId(attemptId)));
    },
    
    getExamResult: async (attemptId) => {
      return await apiClient.get<ExamResult>(ATTEMPT_ENDPOINTS.result.replace(':id', toLongId(attemptId)));
    },
    
    getFlaggedQuestions: async (attemptId) => {
      return await apiClient.get<FlaggedQuestion[]>(ATTEMPT_ENDPOINTS.flags.replace(':id', toLongId(attemptId)));
    },
    ...
    submitExam: async (attemptId, answers) => {
      return await apiClient.post<ExamResult>(
        ATTEMPT_ENDPOINTS.submit.replace(':id', toLongId(attemptId)),
    ...
    uploadJson: async (data) => {
      return await apiClient.post<Exam>(PAPER_ENDPOINTS.uploadJson, data);
    }
  }
);
