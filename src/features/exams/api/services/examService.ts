 ...
 * using the TanStack Query API pattern.
 */
import { 
...
/**
 * Exam service using the extended API service pattern
 * Providing consistent API interface for exam operations
 */
export const examService = createExtendedApiService<Exam, {
  ...
  // Import apiClient for the implementation
  apiClient,
