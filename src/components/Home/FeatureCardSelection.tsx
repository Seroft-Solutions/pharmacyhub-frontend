  ...
  return (
    <section className="text-center py-16 bg-white">
      ...
      <p className="text-gray-600 mb-8">
        Pharmacy Hub is a comprehensive platform offering a wide range of services related to the retail pharmacy
        sector.
        Its mission is to support proprietors, pharmacists, sales staff, and individuals aspiring to establish their own
        pharmacies.
      </p>
        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2
                className="text-xl font-medium text-gray-800 mb-2 group-hover:text-red-500 transition-colors duration-300">
                {feature.title}
              </h2>
