    ...
    <div className="bg-teal-900 text-white py-16 px-8 flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="md:w-1/2 space-y-4">
        ...
        <p className="text-base text-gray-300">
          At vero eos et accusam justo duo dolores et ea rebum clita kasd gubergren nosea takimata sanctus est lorem
          ipsum dolor consectetur sadipscing et sed diam nonumy eirmod tempor invidunt ut labore magna aliquyam sedam
          voluptua.
        </p>
